...
for(i in 5:18){
  ...
  summary(regBA)
  graph=plot(propjuveniles~propBA, xlab="Proportion BA", ylab="Juvenile Proportion", main=colnames(juvies.tree)[i+23])
  abline(regBA)
}
...
for(i in 5:18){
  ...
  summary(regBA)
  graph=plot(propjuveniles~juvab[,i-4], xlab="Proportion BA", ylab="Juvenile Abundance", main=colnames(juvies.tree)[i+23])
  abline(regBA)
}
```
