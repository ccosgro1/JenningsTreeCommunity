...
hel.rda.fulsoil_long = rda(tree.hel.soil[,c(6,9:10,23,27,30)], tree.hel.soil[,45:52]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)

##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,c(6,9:10,23,27,30)]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,c(6,9:10,23,27,30)], tree.hel.soil[,45:52])

hel.rda.fulsoil.full=rda(tree.hel.soil[,c(6,9:10,23,27,30)]~tree.hel.soil$Ptot_long+tree.hel.soil$Po_long+tree.hel.soil$pH_long+tree.hel.soil$moist_long +tree.hel.soil$ps1_long+tree.hel.soil$ps2_long+tree.hel.soil$percc_long+tree.hel.soil$cton_long)
...
hel.rda.selsoil = rda(tree.hel.soil[,c(6,9:10,23,27,30)] ~ as.matrix(tree.hel.soil[,c(51)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil)
plot(hel.rda.selsoil)

#Back to RDAs
hel.rda.fulsoil_nug=rda(tree.hel.soil[,c(6,9:10,23,27,30)], tree.hel.soil[,c(53:61)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,c(6,9:10,23,27,30)], tree.hel.soil[,c(62:69)]) #variables_long. significant: p=0.006
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,c(6,9:10,23,27,30)], tree.hel.soil[,c(45:52)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
hel.rda.fulsoil_nug=rda(tree.hel.soil[,c(6,9:10,23,27,30)], tree.hel.soil[,c(53:61)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,c(6,9:10,23,27,30)], tree.hel.soil[,c(62:69)]) #variables_long. significant: p=0.006
...
juvies=juvies1
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,c(7:8,15:17,20,24,26,29,32,34:35)], tree.hel.soil[,45:52]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)

##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,c(7:8,15:17,20,24,26,29,32,34:35)]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,c(7:8,15:17,20,24,26,29,32,34:35)], tree.hel.soil[,45:52])

hel.rda.fulsoil.full=rda(tree.hel.soil[,c(7:8,15:17,20,24,26,29,32,34:35)]~tree.hel.soil$Ptot_long+tree.hel.soil$Po_long+tree.hel.soil$pH_long+tree.hel.soil$moist_long +tree.hel.soil$ps1_long+tree.hel.soil$ps2_long+tree.hel.soil$percc_long+tree.hel.soil$cton_long)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,c(7:8,15:17,20,24,26,29,32,34:35)] ~ as.matrix(tree.hel.soil[,c(47:48)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil)
plot(hel.rda.selsoil)

#Back to RDAs
hel.rda.fulsoil_nug=rda(tree.hel.soil[,c(7:8,15:17,20,24,26,29,32,34:35)], tree.hel.soil[,c(53:61)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,c(7:8,15:17,20,24,26,29,32,34:35)], tree.hel.soil[,c(62:69)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_short)
RsquareAdj(hel.rda.fulsoil_long)
RsquareAdj(hel.rda.fulsoil_nug)
RsquareAdj(hel.rda.fulsoil_short)
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,c(7:8,15:17,20,24,26,29,32,34:35)], tree.hel.soil[,c(45:52)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
hel.rda.fulsoil_nug=rda(tree.hel.soil[,c(7:8,15:17,20,24,26,29,32,34:35)], tree.hel.soil[,c(53:61)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,c(7:8,15:17,20,24,26,29,32,34:35)], tree.hel.soil[,c(62:69)]) #variables_long. significant: p=0.006
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,32], tree.hel.soil[,45:52]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
hel.rda.fulsoil_nug=rda(tree.hel.soil[,32], tree.hel.soil[,c(53:61)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,32], tree.hel.soil[,c(62:69)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_short)
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,32], tree.hel.soil[,c(45:52)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
hel.rda.fulsoil_nug=rda(tree.hel.soil[,32], tree.hel.soil[,c(53:61)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,32], tree.hel.soil[,c(62:69)]) #variables_long. significant: p=0.006
...
One more time comparing juvrniles against the soil variables selected with total community forward selection (selected in SeedlingStats.R)
```{r ACERUB}
###ACERUB adults are correlated with ptot_long
tree.hel.soil=juvies1
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,6], tree.hel.soil[,c(47,48,56,55,65)]) # not significant
anova(hel.rda.fulsoil_long)
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,7], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. significant: p=0.004
anova(hel.rda.fulsoil_long)
##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,7]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,7], tree.hel.soil[,c(47,48,56,55,65)])

hel.rda.fulsoil.full=rda(tree.hel.soil[,7]~tree.hel.soil$pH_long+tree.hel.soil$moist_long+tree.hel.soil$pH_nug+tree.hel.soil$moist_short+tree.hel.soil$moist_nug)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel #whole model

# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,7] ~ as.matrix(tree.hel.soil[,c(47,48,56,55)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil) #0.538
#plot(hel.rda.selsoil)
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,7], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. not significant
anova(hel.rda.fulsoil_long)
...
# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,7] ~ as.matrix(tree.hel.soil[,c(48,56)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil) #0.538
#plot(hel.rda.selsoil)
```
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,30], tree.hel.soil[,c(47,48,56,55,65)]) #not significant
anova(hel.rda.fulsoil_long)
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,15], tree.hel.soil[,c(47,48,56,55,65)]) #significant: p=0.001
anova(hel.rda.fulsoil_long)
##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,15]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,15], tree.hel.soil[,c(47,48,56,55,65)])

hel.rda.fulsoil.full=rda(tree.hel.soil[,15]~tree.hel.soil$pH_long+tree.hel.soil$moist_long+tree.hel.soil$pH_nug+tree.hel.soil$moist_short+tree.hel.soil$moist_nug)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel #pH_long

# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,15] ~ as.matrix(tree.hel.soil[,c(47,48,56)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil) #0.247
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,15], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. significant: p=0.029
anova(hel.rda.fulsoil_long)
##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,15]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,15], tree.hel.soil[,c(47,48,56,55,65)])
...
# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,15] ~ as.matrix(tree.hel.soil[,c(47,56)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil) #0.395
...
dim(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,15], tree.hel.soil[,c(47,48,56,55,65)]) #significant: p=0.019
anova(hel.rda.fulsoil_long)
##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,15]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,15], tree.hel.soil[,c(47,48,56,55,65)])
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,10], tree.hel.soil[,c(47,48,56,55,65)]) #not significant
anova(hel.rda.fulsoil_long)

hel.rda.fulsoil.none = rda(tree.hel.soil[,10]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,10], tree.hel.soil[,c(47,48,56,55,65)])

hel.rda.fulsoil.full=rda(tree.hel.soil[,10]~tree.hel.soil$pH_long+tree.hel.soil$moist_long+tree.hel.soil$pH_nug+tree.hel.soil$moist_short+tree.hel.soil$moist_nug)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel #pH_long
# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,10] ~ 1)
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil) #0.247
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,16], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. not significant
anova(hel.rda.fulsoil_long)

##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,16]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,16], tree.hel.soil[,c(47,48,56,55,65)])

hel.rda.fulsoil.full=rda(tree.hel.soil[,16]~tree.hel.soil$pH_long+tree.hel.soil$moist_long+tree.hel.soil$pH_nug+tree.hel.soil$moist_short+tree.hel.soil$moist_nug)
tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel #percc_long

# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,16] ~ as.matrix(tree.hel.soil[,c(47,56)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil) #0.334
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,16], tree.hel.soil[,c(47,48,56,55,65)]) #significant: p=0.035
anova(hel.rda.fulsoil_long)
##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,16]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,16], tree.hel.soil[,c(47,48,56,55,65)])
...
# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,16] ~ as.matrix(tree.hel.soil[,c(47,56,65)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil) #0.326
```
```{r PRUSER}
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,26], tree.hel.soil[,c(47,48,56,55,65)]) #not significant
anova(hel.rda.fulsoil_long)
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,27], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,20], tree.hel.soil[,c(47,48,56,55,65)]) #not significant
anova(hel.rda.fulsoil_long)
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,20], tree.hel.soil[,c(47,48,56,55,65)]) #not enough data
anova(hel.rda.fulsoil_long)
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,23], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. significant: p=0.011
anova(hel.rda.fulsoil_long)
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,23], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,8], tree.hel.soil[,c(47,48,56,55,65)]) #not significant
anova(hel.rda.fulsoil_long)

##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,8]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,8], tree.hel.soil[,c(47,48,56,55,65)])

hel.rda.fulsoil.full=rda(tree.hel.soil[,8]~tree.hel.soil$pH_long+tree.hel.soil$moist_long+tree.hel.soil$pH_nug+tree.hel.soil$moist_short+tree.hel.soil$moist_nug)
tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel #percc_long

# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,8] ~ as.matrix(tree.hel.soil[,c(47)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil) #0.334
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,24], tree.hel.soil[,c(47,48,56,55,65)]) #not significant
anova(hel.rda.fulsoil_long)
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,9], tree.hel.soil[,c(47,48,56,55,65)]) #significant: p=0.041
anova(hel.rda.fulsoil_long)
RsquareAdj(hel.rda.fulsoil_long) #0.0997
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,9], tree.hel.soil[,c(47,48,56,55,65)]) #not significant
anova(hel.rda.fulsoil_long)
...
dim(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,9], tree.hel.soil[,c(47,48,56,55,65)]) #significant: p=0.04
anova(hel.rda.fulsoil_long)
RsquareAdj(hel.rda.fulsoil_long) #0.117
```
```{r QUEPAL}
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,29], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. significant: p=0.036
anova(hel.rda.fulsoil_long)
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,29], tree.hel.soil[,c(47,48,56,55,65)]) #not significant
anova(hel.rda.fulsoil_long)
...
dim(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,29], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
```
```{r ULMSP (lumped)}
###ULMSP adults are correlated with Po_short & cton_short
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,34:35], tree.hel.soil[,c(47,48,56,55,65)]) #not significant
anova(hel.rda.fulsoil_long)
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,34:35], tree.hel.soil[,c(47,48,56,55,65)]) #not signiciant
anova(hel.rda.fulsoil_long)
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,17], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,17]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,17], tree.hel.soil[,c(47,48,56,55,65)])

hel.rda.fulsoil.full=rda(tree.hel.soil[,17]~tree.hel.soil$pH_long+tree.hel.soil$moist_long+tree.hel.soil$pH_nug+tree.hel.soil$moist_short+tree.hel.soil$moist_nug)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel #null model

# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,17] ~ as.matrix(tree.hel.soil[,c(47)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil)
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,17], tree.hel.soil[,c(47,48,56,55,65)]) #variables_long. significant: p=0.021
anova(hel.rda.fulsoil_long)
##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,17]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,17], tree.hel.soil[,c(47,48,56,55,65)])
...
# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,17] ~ 1)
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil)
...
dim(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,17], tree.hel.soil[,c(47,48,56,55,65)]) #not significant
anova(hel.rda.fulsoil_long)
```