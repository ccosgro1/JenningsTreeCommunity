...
hel.rda.fulsoil_long = rda(tree.hel.soil[,c(6,10:11,25:26,29,32)], tree.hel.soil[,48:55]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)

##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,c(6,10:11,25:26,29,32)]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,c(6,10:11,25:26,29,32)], tree.hel.soil[,48:55])

hel.rda.fulsoil.full=rda(tree.hel.soil[,c(6,10:11,25:26,29,32)]~tree.hel.soil$Ptot_long+tree.hel.soil$Po_long+tree.hel.soil$pH_long+tree.hel.soil$moist_long+tree.hel.soil$ps1_long+tree.hel.soil$ps2_long+tree.hel.soil$percc_long+tree.hel.soil$cton_long)
...
hel.rda.selsoil = rda(tree.hel.soil[,c(6,10:11,25:26,29,32)] ~ as.matrix(tree.hel.soil[,c(48)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil)
plot(hel.rda.selsoil)

#Back to RDAs
hel.rda.fulsoil_nug=rda(tree.hel.soil[,c(6,10:11,25:26,29,32)], tree.hel.soil[,c(56:64)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,c(6,10:11,25:26,29,32)], tree.hel.soil[,c(65:72)]) #variables_long. significant: p=0.006
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,c(6,10:11,25:26,29,32)], tree.hel.soil[,c(48:55)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
hel.rda.fulsoil_nug=rda(tree.hel.soil[,c(6,10:11,25:26,29,32)], tree.hel.soil[,c(56:64)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,c(6,10:11,25:26,29,32)], tree.hel.soil[,c(65:72)]) #variables_long. significant: p=0.006
...
# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,c(6,10:11,25:26,29,32)] ~ as.matrix(tree.hel.soil[,c(48,53)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil)
plot(hel.rda.selsoil)
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,c(7,9,18:21,24,28,31,35:38)], tree.hel.soil[,48:55]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)

##NEW forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,c(7,9,18:21,24,28,31,35:38)]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,c(7,9,18:21,24,28,31,35:38)], tree.hel.soil[,48:55])

hel.rda.fulsoil.full=rda(tree.hel.soil[,c(7,9,18:21,24,28,31,35:38)]~tree.hel.soil$Ptot_long+tree.hel.soil$Po_long+tree.hel.soil$pH_long+tree.hel.soil$moist_long+tree.hel.soil$ps1_long+tree.hel.soil$ps2_long+tree.hel.soil$percc_long+tree.hel.soil$cton_long)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel #whole model

# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,c(7,9,18:21,24,28,31,35:38)] ~ as.matrix(tree.hel.soil[,c(48,54)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil)
plot(hel.rda.selsoil)

#Back to RDAs
hel.rda.fulsoil_nug=rda(tree.hel.soil[,c(7,9,18:21,24,28,31,35:38)], tree.hel.soil[,c(56:64)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,c(7,9,18:21,24,28,31,35:38)], tree.hel.soil[,c(65:72)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_short)
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,c(7,9,18:21,24,28,31,35:38)], tree.hel.soil[,c(48:55)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
...
# Constructing a model with selected variables.
hel.rda.selsoil = rda(tree.hel.soil[,c(7,9,18:21,24,28,31,35:38)] ~ as.matrix(tree.hel.soil[,c(49)]))
anova(hel.rda.selsoil)
RsquareAdj(hel.rda.selsoil)
plot(hel.rda.selsoil)
...
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
colnames(tree.hel.soil)
hel.rda.fulsoil_long = rda(tree.hel.soil[,35], tree.hel.soil[,48:55]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
hel.rda.fulsoil_nug=rda(tree.hel.soil[,35], tree.hel.soil[,c(56:64)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,35], tree.hel.soil[,c(65:72)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_short)
...
colnames(tree.hel.soil)
# Here is the global analysis. Can proceed if significant.  Use adj. R square as additional stopping criterion.
hel.rda.fulsoil_long = rda(tree.hel.soil[,35], tree.hel.soil[,c(48:55)]) #variables_long. significant: p=0.006
anova(hel.rda.fulsoil_long)
hel.rda.fulsoil_nug=rda(tree.hel.soil[,35], tree.hel.soil[,c(56:64)]) #variables_nug. not significant.
anova(hel.rda.fulsoil_nug)
hel.rda.fulsoil_short = rda(tree.hel.soil[,35], tree.hel.soil[,c(65:72)]) #variables_long. significant: p=0.006
...
Do this all over again, but with ONLY the soil variables associated with the total seedling community
